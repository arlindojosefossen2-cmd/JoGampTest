...
public final class GL2Graphics
{
	...
	{
		drawTexture(texture,FloatColorPalette.WHITE,x,y,width,height,rotation);
	}

	public void drawTexture(Texture texture,IntColor color, float x, float y, float width, float height, float rotation)
	{
		if(GLWindowEventListener.getGl2() != null)
		{
			gl2 = GLWindowEventListener.getGl2();
	...
	public void drawTexture(Texture texture,FloatColor color, float x, float y, float width, float height, float rotation)
	{
		if(GLWindowEventListener.getGl2() != null)
		{
			gl2 = GLWindowEventListener.getGl2();
